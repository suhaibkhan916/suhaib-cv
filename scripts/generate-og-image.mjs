...
<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="132" y="146" font-family="JetBrains Mono, monospace" font-size="16" fill="#8b98ac">Bristol, UK &#183; Open to UK &amp; EU relocation</text>

  <text x="88" y="270" font-family="Space Grotesk, Arial, sans-serif" font-size="74" font-weight="700" fill="#e2e8f0">Muhammad Suhaib</text>
  <text x="90" y="320" font-family="Inter, Arial, sans-serif" font-size="34" font-weight="500" fill="#8b98ac">Software Engineer &#183; MSc Cyber Security</text>

  <text x="90" y="380" font-family="JetBrains Mono, monospace" font-size="20" fill="#57667c">$ building &#8594; <tspan fill="#22d3ee">Python &#183; Azure &#183; GCP &#183; Automation &#183; Cyber Security</tspan></text>
