...
const s = StyleSheet.create({
  ...
  photoRing: { width: 100, height: 100, borderRadius: 50, alignSelf: 'center', marginBottom: 10, borderWidth: 1.6, borderColor: SOFT, justifyContent: 'center', alignItems: 'center' },
